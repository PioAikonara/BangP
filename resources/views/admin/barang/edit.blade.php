            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" required
                        ...
                        <option value="Toiletries" {{ old('kategori', $barang->kategori) == 'Toiletries' ? 'selected' : '' }}>Toiletries</option>
                        <option value="Protein" {{ old('kategori', $barang->kategori) == 'Protein' ? 'selected' : '' }}>Protein</option>
                        <option value="Pembersih" {{ old('kategori', $barang->kategori) == 'Pembersih' ? 'selected' : '' }}>Pembersih</option>
                    </select>
                    @error('kategori')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="ukuran" id="ukuran" value="{{ old('ukuran', $barang->ukuran) }}"
                        placeholder="Contoh: 1kg, 500ml, 250 gram"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('ukuran') border-red-500 @enderror">
                    @error('ukuran')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="harga_beli" id="harga_beli" value="{{ old('harga_beli', $barang->harga_beli) }}" required min="0"
                ...
                <div>
                    ...
                    <input type="number" name="diskon" id="diskon" value="{{ old('diskon', $barang->diskon) }}" min="0" max="100"
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex items-center space-x-4">
                        <img src="{{ Storage::url($barang->gambar) }}" alt="{{ $barang->nama_barang }}" class="w-32 h-32 object-cover rounded-lg border border-gray-300">
                ...
                <div class="md:col-span-2">
                    <label for="gambar" class="block text-sm font-medium text-gray-700 mb-2">
                        {{ $barang->gambar ? 'Ganti Gambar Produk' : 'Upload Gambar Produk' }}
                    </label>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="3"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $barang->deskripsi) }}</textarea>
                    @error('deskripsi')
                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                    @enderror
                </div>
