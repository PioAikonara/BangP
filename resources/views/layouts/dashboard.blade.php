            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gradient-to-b from-blue-600 to-indigo-700">
                ...
                <ul class="space-y-2 font-medium">
                    @if(auth()->user()->isAdmin())
                        ...
                        <li>
                            <a href="{{ route('admin.pegawai.index') }}" class="flex items-center p-3 rounded-lg {{ request()->routeIs('admin.pegawai.*') ? 'bg-white text-blue-600' : 'text-white hover:bg-blue-700' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('pembeli.keranjang') }}" class="flex items-center p-3 rounded-lg {{ request()->routeIs('pembeli.keranjang') ? 'bg-white text-blue-600' : 'text-white hover:bg-blue-700' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                                </svg>
                        ...
                        <li>
                            <a href="{{ route('pembeli.pesanan.index') }}" class="flex items-center p-3 rounded-lg {{ request()->routeIs('pembeli.pesanan.*') ? 'bg-white text-blue-600' : 'text-white hover:bg-blue-700' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/>
                                </svg>
