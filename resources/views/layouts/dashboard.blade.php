    ...
    <div class="min-h-screen">
        ...
        <div class="sm:ml-64">
            ...
            <main class="min-h-screen bg-gray-50">
                @if(session('success'))
                    <div class="mb-4 mx-6 mt-6 bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block sm:inline">{{ session('success') }}</span>
                    </div>
                @endif

                @if(session('error'))
                    <div class="mb-4 mx-6 mt-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
